...
'Choose one academic region': 'Choose one academic region',
'Choose one IHE': 'Choose one IHE',
'Choose one province': 'Choose one province',
'Choose one:': 'Choose one:',
...
'Twitter': 'Twitter',
'Two-digit code': 'Código de 2 algarismos',
