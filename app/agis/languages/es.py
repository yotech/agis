...
'Código': 'Código',
'Código asignado por la escuela a la unidad organica': 'Código asignado por la escuela a la unidad organica',
'Código de 3 digitos en el Ministerio': 'Código de 3 digitos en el Ministerio',
'Código de dos digitos': 'Código de dos digitos',
'Código de Escuela': 'Código de Escuela',
'Código de Registro': 'Código de Registro',
'Código de registro': 'Código de registro',
'Código de registro en el ministerio': 'Código de registro en el ministerio',
...
'Descripcion de carrera': 'Descripcion de carrera',
